...
export default function Header() {
  return (
    ...
    <div className="App d-flex justify-content-end p-1">
      <Link className="btn btn-outline-light" state={{marginLeft:"20px"}} to="/viewemp">View Emp</Link>
    </div>
    <div className="App d-flex justify-content-end p-1">
      <Link className="btn btn-outline-light" state={{marginLeft:"20px"}} to="/addemp">Add Emp</Link>
    </div>
